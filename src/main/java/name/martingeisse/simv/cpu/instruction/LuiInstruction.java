 ...
 * field must be zero.
 */
public final class LuiInstruction implements Instruction {

    private final int registerIndexDestination;
    private final int upperBits;

    public LuiInstruction(int registerIndexDestination, int upperBits) {
    ...
    public void execute(Cpu cpu) {
        cpu.setRegister(registerIndexDestination, upperBits);
        cpu.incPc();
    }
